...
namespace Prise.Tests.DefaultAssemblyLoadStrategy
{
    public class DefaultAssemblyLoadStrategyBase : TestBase
    {
        ...
        protected Func<IPluginLoadContext, AssemblyName, ValueOrProceed<AssemblyFromStrategy>> CreateLookupFunction(Func<IPluginLoadContext, AssemblyName, ValueOrProceed<AssemblyFromStrategy>> func) => func;
