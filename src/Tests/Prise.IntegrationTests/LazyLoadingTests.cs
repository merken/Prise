...
{
    public class LazyLoadingTests : CalculationPluginTestsBase
    {
        public LazyLoadingTests() : base(AppHostWebApplicationFactory.Default()) { }
        ...
        public async Task PluginC_multi_async_Works()
        {
            ...
            //Act
            var result = await Post<CalculationResponseModel>(_client, "PluginC", "/lazy/multi-async", payload);
