...
namespace LanguageBased.Plugin
{
    ...
    public class TranslationPlugin : ITranslationPlugin
    {
        ...
        public IEnumerable<TranslationOutput> Emumerable { get; private set; }

        protected TranslationPlugin(IConfiguration configuration, ICurrentLanguageProvider languageProvider, IDictionaryService dictionaryService)
        {
